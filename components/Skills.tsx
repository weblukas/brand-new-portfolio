...
const Skills = () => {
  ...
  return (
    <div
      ref={ref} 
      className="lg:col-span-2 flex flex-wrap text-[18px]"
    >
      {skills.map((skil) => (
        <motion.div
          key={skil.id}
          className="bg-white border-2 m-1 lg:m-2 rounded-xl px-3 py-1 lg:px-5 lg:py-2 dark:bg-white/5 dark:text-white/80"
